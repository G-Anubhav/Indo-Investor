const dholeraSkyRiseResidency = {
  ...
  price: "Registration Start @ ₹21,000/- Secure your own Plot",
  perUnit: "₹ 8,999 per square yards onwards",
  rating: 4.5,
  reviewCount: 21,
  status: "Government Approved Plots, \n 50% Payment par Plot Registry, Easy & Flexible EMI Payment Plan",
  size: "6 Acres, 207 Well-Planned Plots, Minimum Plot Size: 91 Sq. Yards",
  configurations: [
  ...
  images: [
    ...
    "/images/all-properties/residential/dholera-green-vista/3.jpeg",
    "/images/all-properties/residential/dholera-green-vista/4.jpeg",
    "/images/all-properties/residential/dholera-green-vista/5.jpeg",
    "/images/all-properties/residential/dholera-green-vista/6.jpeg",
    "/images/all-properties/residential/dholera-green-vista/7.jpeg",
    "/images/all-properties/residential/dholera-green-vista/8.jpeg",
    "/images/all-properties/residential/dholera-green-vista/9.jpeg",
    "/images/all-properties/residential/dholera-green-vista/10.jpeg",
  ],
  description: [
    "Green Vista Residential Township - Dholera is a premium residential township located in the fast-developing Dholera SIR, India’s first government-backed smart city. Spread across approximately 6 acres with around 207 well-planned residential plots, the project is designed for investors and end-users seeking long-term appreciation, security, and modern infrastructure.",
  ...
  layoutSection: {
    ...
    features: [
      "Detailed Land Layout Plan",
      "N.A. Order Stamp Papers",
      "Plot Demarcation & Road Access",
      "Approved Road Width & Green Areas",
    ],
    pdf: {
      url: "/brochure/dholera-green-vista/layout.pdf",
  ...
  documentData : {
    ...
    subtitle:
      "Verified & confidential documents related to this property. View-only access provided.",
    documents: [
      {
        title: "Aakaru-258-Registered Sale deed",
        description: "Non-Agricultural Land Approval",
        file: "/brochure/dholera-green-vista/Aakaru-258-Registered Sale deed No.2578-Dt.30-09-2024-Nileshbhai Gagjibhai Patel & Other in favor  of Nirubhai Manjibhai Makwana-Khati to Khati-HM.pdf",
      },
      {
        title: "Aakru-258-NA Order-Residential Purpose & LayOut",
        description: "Authority approved site layout",
        file: "/brochure/dholera-green-vista/Aakru-258-NA Order-Residential Purpose & LayOut (1) (1).pdf",
      },
      {
        title: "Aakru-258-Plan Pass - 1",
        description: "Land ownership verification",
        file: "/brochure/dholera-green-vista/dholera-green-vista\Aakru-258-Plan Pass (1).pdf",
      },
      {
        title: "Aakru-258-Plan Pass - 2",
        description: "Land ownership verification",
        file: "/brochure/dholera-green-vista/dholera-green-vista\Aakru-258-Plan Pass.pdf",
      },
      {
        title: "Aakru-258-Title Report - NJ-HM",
        description: "Land ownership verification",
        file: "/brochure/dholera-green-vista/Aakru-258-Title Report - NJ-HM.pdf",
      },
      {
        title: "Akaru-258-NA Final Order-Residential Purpose",
        description: "Land ownership verification",
        file: "/brochure/dholera-green-vista/Akaru-258-NA Final Order-Residential Purpose.pdf",
      },
      {
        title: "Akaru-258-Paper Notice",
        description: "Paper Notice",
        file: "/brochure/dholera-green-vista/Akaru-258-Paper Notice-Dt.13-01-2024-NJ.jpeg",
      },
    ],
  },
  paymentPlan: [
  ...
  amenities: [
    { label: "40 ft Wide Main Road", icon: "/images/icons/road.svg" },
    { label: "Jogging Track", icon: "/images/icons/running-stick.svg" },
    { label: "Cricket", icon: "/images/icons/cricket.svg" },
    { label: "Swimming Pool", icon: "/images/icons/pool.svg" },
    { label: "Table Tennis", icon: "/images/icons/table-tennis.svg" },
    { label: "Senior Citizens", icon: "/images/icons/senior-citizens.png" },
    { label: "Children Playground", icon: "/images/icons/playground.png" },
    { label: "Pool Table", icon: "/images/icons/pool-table.svg" },
    { label: "Badminton", icon: "/images/icons/badminton.svg" },
    { label: "24Hr Water", icon: "/images/icons/plumbering-water-supply.svg" },
    { label: "Temple", icon: "/images/icons/hindu-temple.svg" },
    { label: "Parking", icon: "/images/icons/parking.svg" },
  ...
  videoUrl: "/images/all-properties/residential/dholera-green-vista/dholera-green-vista.mp4",
  mapEmbedUrl:
  ...
  reviews: [
    {
      ...
      rating: 5,
      review:
        "Best entry-level investment in Dholera. Clear documents and immediate registry gave us full confidence.",
      image: "/images/clients/amit.jpg",
    },
    {
      name: "Kunal Mehta",
      rating: 4.5,
      review:
        "Great location near Diamond Circle. The pricing is very attractive considering Dholera’s future growth.",
      image: "/images/clients/kunal.jpg",
    },
    {
      name: "Sneha Joshi",
      rating: 4,
      review:
        "Ideal for long-term investors. Infrastructure planning looks solid and well thought out.",
...
export default dholeraSkyRiseResidency;
