...
import bhutaniCyberthum from "@/data/propertyDetails/office/bhutani-cyberthum";

const CyberthumPage = () => {
  const { title, bannerImage, breadcrumbs } = bannerBreadcrumb.office.bhutaniCyberthum;
