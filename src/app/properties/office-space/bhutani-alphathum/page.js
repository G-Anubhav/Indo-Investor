...
import bhutaniAlphathum from "@/data/propertyDetails/office/bhutani-alphathum";

const AlphathumPage = () => {
  const { title, bannerImage, breadcrumbs } = bannerBreadcrumb.office.bhutaniAlphathum;
